...
int main(){
    ...
    //data
    TFile * fs_data = new TFile("/work/clas12/users/gjwei/ForwardTagger/2pion_ftpid/build_new1/output3_ftpid_strict_cut.root", "r");
    ...
    //simulation
    TFile * fs_simu = new TFile("/work/clas12/users/gjwei/ForwardTagger/2pion_ftpid/build_new1/output3_ftpid_strict_cut_simu.root", "r");
