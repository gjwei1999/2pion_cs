...
int main(){
    ...
    double convert;
    convert = 865631.5577 * 1e-9 / e_charge * density / mp * thickness; //1.14e39  
    ...
    //data
    TFile * fs_data = new TFile("/work/clas12/users/gjwei/ForwardTagger/analysis/build_new/output3.root", "r");
    ...
    //simulation
    TFile * fs_simu = new TFile("/work/clas12/users/gjwei/acceptance/rga_eft/out_rgaft_simu2.root", "r");
    ...
    TFile * fs_519 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/rga_ori_lund/original_519.root", "r");
    ...
    TFile * fs_523 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/rga_ori_lund/original_523.root", "r");
    ...
    TFile * fs_525 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/rga_ori_lund/original_525.root", "r");
    ...
    TFile * fs_543 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/rga_ori_lund/original_543.root", "r");
