...
//    TString filename = "crosssection.root";
  ...
  //  TFile * fs = new TFile(filename.Data(), "RECREATE");
    ...
    //data
    TFile * fs_data = new TFile("/work/clas12/users/gjwei/ForwardTagger/2pion_ftpid/build_new/output3_strict_cut.root", "r");
    ...
    //simulation
    TFile * fs_simu = new TFile("/work/clas12/users/gjwei/ForwardTagger/2pion_ftpid/build_new/output3_strict_cut_simu.root", "r");
...
//
    ...
    h519_4->GetXaxis()->SetRangeUser(0.0,1.0);
    h519_4->Draw();
    hsimu_4->Draw("same");
    leg4->Draw("same");    
return 1;
