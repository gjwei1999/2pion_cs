...
int main(){
    ...
    double convert;
    convert = 1765258 * 1e-9 / e_charge * density / mp * thickness; //
    ...
    //data
    TFile * fs_data = new TFile("/work/clas12/users/gjwei/multi_thr_clas12_ana/build_new/output3_only50.root", "r");
    ...
    //simulation
    TFile * fs_simu = new TFile("/work/clas12/users/gjwei/acceptance/code_original/rga_only50_script/output_only50_simu.root", "r");
    ...
    TFile * fs_519 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/rga_only50_script/original_lund/original_492.root", "r");
    ...
    TFile * fs_523 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/rga_only50_script/original_lund/original_493.root", "r");
    ...
    TFile * fs_525 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/rga_only50_script/original_lund/original_498.root", "r");
    ...
    TFile * fs_543 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/rga_only50_script/original_lund/original_499.root", "r");
