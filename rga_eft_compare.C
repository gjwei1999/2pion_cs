...
//original from generator
    TFile * fs_519 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/rga_eft_ori_lund/original_519.root", "r");     TH1D * h519_0 = (TH1D *) fs_519->Get("MpPip");
    ...
    TFile * fs_525 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/rga_eft_ori_lund/original_525.root", "r");     TH1D * h525_0 = (TH1D *) fs_525->Get("MpPip");
    ...
    h519_2->Add(h523_2,1);                                                                                               h519_2->Add(h525_2,1);       
    h519_2->Add(h543_2,1);
