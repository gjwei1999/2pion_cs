...
int main(){
    ...
    TFile * fs_519 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/ori_lund/original_519.root", "r");
    ...
    TFile * fs_523 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/ori_lund/original_523.root", "r");
    ...
    TFile * fs_525 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/ori_lund/original_525.root", "r");
    ...
    TFile * fs_543 = new TFile("/work/clas12/users/gjwei/acceptance/code_original/ori_lund/original_543.root", "r");
